...
public class PhoneAccountUtils {
    public static final String TEST_PHONE_ACCOUNT_ID = "test2";
    public static final String TEST_PHONE_ACCOUNT_LABEL = "Mygame Test";
    public static final Uri TEST_PHONE_ACCOUNT_ADDRESS = Uri.parse("sip:test@android.com");

    public static final PhoneAccountHandle TEST_PHONE_ACCOUNT_HANDLE =
            new PhoneAccountHandle(new ComponentName(CtsConnectionService.class.getPackage().getName(),
    ...
    public static final String TEST_SELF_MANAGED_PHONE_ACCOUNT_LABEL = "MygameTest";
    ...
    public static final PhoneAccountHandle TEST_SELF_MANAGED_PHONE_ACCOUNT_HANDLE =
            new PhoneAccountHandle(new ComponentName(
                    CtsConnectionService.class.getPackage().getName(),
